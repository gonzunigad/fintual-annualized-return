...
test('it can calculates profit with multiple stocks', () => {
    const portfolio = new Portfolio;
    const from = '2020/11/29';
    const to = '2021/11/29';
    portfolio.addStock(new Stock('AAPL', {[from]: 10, [to]: 100}))
...
test('it can calculates annualized return with multiple stocks', () => {
    const portfolio = new Portfolio;
    const from = '2020/11/29';
    const to = '2022/06/26';
    portfolio.addStock(new Stock('AAPL', {[from]: 100, [to]: 123.74}))
    portfolio.addStock(new Stock('TSLA', {[from]: 1000, [to]: 1237.4}))
